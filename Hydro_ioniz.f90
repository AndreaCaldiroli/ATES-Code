      ...
      do while(du.ge.du_th.and.count.le.1000)
 		...
 		! Evaluate ionization equilibrium condition
 		call eval_ioniz_eq(u,f_sp,u,f_sp,eta,heat,cool)       
