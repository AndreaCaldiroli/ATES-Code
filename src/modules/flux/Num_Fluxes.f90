      ...
      use Conversion
      use S_estimate_HLLC          ! Speed estimate for HLLC scheme
      use S_estimate_ROE
	...
	real*8 :: a1,a2,a3   
      ...
      ! Extract left and right states in phisical variables
      !call U_to_W_comp(uL,WL)
      !call U_to_W_comp(uR,WR)
